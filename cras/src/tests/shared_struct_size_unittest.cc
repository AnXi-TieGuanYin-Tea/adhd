...
TEST(StructSizeTest, All) {
  // Any structure size modification should correspond to a bump in version
  ...
  */
  ...
  EXPECT_EQ(76, sizeof(struct cras_audio_shm_area));
  // struct cras_audio_shm: local
  // --- cras_types.h ---
  EXPECT_EQ(16, sizeof(struct cras_timespec));
  ...
  EXPECT_EQ(25704, sizeof(struct cras_server_state));
