...
static unsigned cras_system_set_volume_value;
static int cras_system_set_volume_called;
static int cras_system_set_capture_gain_value;
static int cras_system_set_capture_gain_called;
static int cras_system_set_mute_value;
static int cras_system_set_mute_called;
static int cras_system_set_user_mute_value;
static int cras_system_set_user_mute_called;
static int cras_system_set_mute_locked_value;
static int cras_system_set_mute_locked_called;
static int cras_system_set_capture_mute_value;
static int cras_system_set_capture_mute_called;
static int cras_system_set_capture_mute_locked_value;
static int cras_system_set_capture_mute_locked_called;
static int cras_make_fd_nonblocking_called;
...
void cras_system_set_volume(unsigned volume)
{
  cras_system_set_volume_value = volume;
  cras_system_set_volume_called++;
}

void cras_system_set_capture_gain(int gain)
{
