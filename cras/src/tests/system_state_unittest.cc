...
TEST(SystemStateSuite, VolumeChangedCallback) {
  ...
  const uint32_t fake_volume = 55;
  const uint32_t fake_volume_2 = 44;
  int rc;
...
TEST(SystemStateSuite, VolumeLimitChangedCallbackMultiple) {
  ...
  const int32_t fake_min = -10000;
  const int32_t fake_max = 800;
  const int32_t fake_min_2 = -4500;
  const int32_t fake_max_2 = -600;
  int rc;
...
TEST(SystemStateSuite, CaptureVolumeChangedCallback) {
  void * const fake_user_arg = (void *)1;
  const int32_t fake_capture_gain = 2200;
  const int32_t fake_capture_gain_2 = -1600;
  int rc;
