...
unsigned cras_system_get_volume()
{
...
int cras_system_get_capture_gain()
{
...
void cras_system_set_volume_limits(int min, int max)
{
...
int cras_system_get_min_volume()
{
	return state.exp_state->min_volume_dBFS;
}

int cras_system_get_max_volume()
{
...
void cras_system_set_capture_gain_limits(int min, int max)
{
...
int cras_system_get_min_capture_gain()
{
	return state.exp_state->min_capture_gain;
}

int cras_system_get_max_capture_gain()
{
